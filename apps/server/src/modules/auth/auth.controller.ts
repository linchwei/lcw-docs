...
export class AuthController {
    ...
    @ApiBody({
        schema: {
            ...
            properties: { username: { type: 'string', description: '用户名' }, password: { type: 'string', description: '密码' } },
        },
    })
    @ApiResponse({
        status: 200,
        ...
        schema: {
            properties: {
                data: { type: 'object', properties: { access_token: { type: 'string', description: 'JWT令牌' } } },
    ...
    @ApiResponse({
        status: 200,
        description: '成功',
        schema: { properties: { data: { type: 'object', properties: { id: { type: 'string' }, username: { type: 'string' } } } } },
    })
