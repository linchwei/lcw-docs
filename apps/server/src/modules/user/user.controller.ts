...
export class UserController {
    ...
    @ApiBody({
        schema: {
            ...
            properties: {
                username: { type: 'string', description: '用户名，3-20位', minLength: 3, maxLength: 20 },
                password: { type: 'string', description: '密码，6-50位', minLength: 6, maxLength: 50 },
            },
        },
    })
    @ApiResponse({
        ...
        schema: {
            properties: {
                data: { type: 'object', properties: { id: { type: 'string' }, username: { type: 'string' } } },
