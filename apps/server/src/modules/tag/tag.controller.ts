...
export class TagController {
    ...
    @ApiBody({
        schema: {
            ...
            properties: {
                ...
                color: { type: 'string', description: '标签颜色（十六进制）' },
            },
        },
    })
    @ApiResponse({
    ...
    @ApiBody({
        schema: {
            ...
            properties: { pageId: { type: 'string', description: '页面ID' }, tagId: { type: 'string', description: '标签ID' } },
        },
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiBody({
        schema: {
            type: 'object',
            required: ['pageIds'],
            properties: { pageIds: { type: 'array', description: '页面ID列表，最多50个', items: { type: 'string' }, maxItems: 50 } },
        },
    })
    @ApiResponse({
        status: 200,
