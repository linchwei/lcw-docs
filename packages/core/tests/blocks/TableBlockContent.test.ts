...
import { Table, TableBlockContent, tablePropSchema } from '../../src/blocks/TableBlockContent/TableBlockContent'
...
describe('TableBlockContent', () => {
    ...
    describe('TableParagraph 创建', () => {
        test('Table 应该包含 tableParagraph 扩展', () => {
            ...
            const hasTableParagraph = requiredExtensions?.some(ext => ext.name === 'tableParagraph')
        ...
        test('Table 应该包含 TableExtension', () => {
            ...
            const hasTableExtension = requiredExtensions?.some(ext => ext.name === 'LcwDocTableExtension')
        ...
        test('Table 应该包含 TableRow', () => {
            ...
            const hasTableRow = requiredExtensions?.some(ext => ext.name === 'tableRow')
