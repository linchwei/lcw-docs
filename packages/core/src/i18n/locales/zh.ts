...
export const zh: Dictionary = {
    slash_menu: {
        ...
        numbered_list: {
            title: '有序列表',
            subtext: '用于显示有序列表',
            aliases: ['ol', 'li', 'list', 'numberedlist', 'numbered list', '列表', '有序列表'],
            group: '基础',
        },
        bullet_list: {
            title: '无序列表',
            subtext: '用于显示无序列表',
            aliases: ['ul', 'li', 'list', 'bulletlist', 'bullet list', '列表', '无序列表'],
            group: '基础',
        },
        check_list: {
            title: '检查清单',
            subtext: '用于显示带有复选框的列表',
            aliases: ['ul', 'li', 'checklist', 'checked list', '列表', '检查清单', '勾选列表', '复选框'],
            group: '基础',
        },
        paragraph: {
            title: '段落',
        ...
        image: {
            title: '图片',
            subtext: '插入图片',
            aliases: ['图片', '上传图片', '上传', 'image', 'img', '相册', '媒体', 'url'],
            group: '媒体',
        },
        video: {
            title: '视频',
            subtext: '插入视频',
            aliases: ['视频', '视频上传', '上传', 'video', 'mp4', '电影', '媒体', 'url', '驱动', 'dropbox'],
            group: '媒体',
        },
        audio: {
            title: '音频',
            subtext: '插入音频',
            aliases: ['音频', '音频上传', '上传', 'audio', 'mp3', '声音', '媒体', 'url', '驱动', 'dropbox'],
            group: '媒体',
        },
        file: {
            title: '文件',
