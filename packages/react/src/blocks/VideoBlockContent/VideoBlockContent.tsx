import { FileBlockConfig, videoBlockConfig, videoParse } from '@lcw-doc/core'
...
export const VideoPreview = (props: Omit<ReactCustomBlockRenderProps<FileBlockConfig, any, any>, 'contentRef'>) => {
...
export const VideoToExternalHTML = (props: Omit<ReactCustomBlockRenderProps<typeof videoBlockConfig, any, any>, 'contentRef'>) => {
...
export const VideoBlock = (props: ReactCustomBlockRenderProps<typeof videoBlockConfig, any, any>) => {
    return (
        <FileBlockWrapper
            {...(props as any)}
