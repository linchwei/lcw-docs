...
import { Sheet, SheetContent } from '@lcw-doc/shadcn-shared-ui/components/ui/sheet'
import { Skeleton } from '@lcw-doc/shadcn-shared-ui/components/ui/skeleton'
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@lcw-doc/shadcn-shared-ui/components/ui/tooltip'
import { useIsMobile } from '@lcw-doc/shadcn-shared-ui/hooks/use-mobile'
...
const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<'li'>>(({ className, ...props }, ref) => (
    <li ref={ref} data-sidebar="menu-item" className={cn('group/menu-item relative flex items-center', className)} {...props} />
))
