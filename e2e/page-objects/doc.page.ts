...
export class DocPage {
    ...
    constructor(page: Page) {
        ...
        this.shareButton = page
            ...
            .or(page.locator('button[aria-label="share"], button[aria-label="分享"]'))
        this.versionButton = page
            .getByRole('button', { name: /版本|version/i })
            .or(page.locator('button[aria-label="version"], button[aria-label="版本"]'))
        this.commentButton = page
            .getByRole('button', { name: /评论|comment/i })
            .or(page.locator('button[aria-label="comment"], button[aria-label="评论"]'))
        this.collaboratorButton = page
            .getByRole('button', { name: /协作|collaborator/i })
            .or(page.locator('button[aria-label="collaborator"], button[aria-label="协作"]'))
