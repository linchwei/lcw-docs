...
import { ComponentProps, elementOverflow, mergeRefs } from '@lcw-doc/react'
...
export const SuggestionMenuItem = forwardRef<HTMLDivElement, ComponentProps['SuggestionMenu']['Item']>((props, ref) => {
    ...
    return (
        <div
            ...
            className={cn(
                'bn:relative bn:flex bn:cursor-pointer bn:select-none bn:items-center bn:rounded-sm bn:px-2 bn:py-1.5 bn:text-sm bn:outline-none bn:transition-colors bn:focus:bg-accent bn:focus:text-accent-foreground bn:data-[disabled]:pointer-events-none bn:data-[disabled]:opacity-50',
                className
            )}
