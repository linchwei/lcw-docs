import { ChangeEvent, ComponentType, createContext, CSSProperties, KeyboardEvent, MouseEvent, ReactNode, useContext } from 'react'
...
export type ComponentProps = {
    FormattingToolbar: {
        ...
        Button: {
            ...
            isSelected?: boolean
            isDisabled?: boolean
        } & ({ children: ReactNode; label?: string } | { children?: undefined; label: string })
        Select: {
            className?: string
            items: {
                text: string
